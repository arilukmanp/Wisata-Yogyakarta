 ...
 * - Version : 1.0
 * - Author : JustFriend Developer Team
 * - License : MIT License
 *
 *
 * Ini adalah file utama javascript yang memuat semua javascript di dashboard.
 * This is a main javascript file which contains all javascript in dashboard.
 *
*/
...
function($) {
	...
	var App = function() {
		this.VERSION = "1.0", 
		this.AUTHOR = "Ari Lukman P.", 
		this.SUPPORT = "info@justfriend.org", 
...
$(function() {
	...
	var activePage = activeUrl + activeMod
