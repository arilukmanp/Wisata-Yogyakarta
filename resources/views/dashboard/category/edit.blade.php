...
@section('title', 'Edit Kategori Destinasi Wisata')
	...
	<div class="row">
		<div class="col-md-12">
			<div class="block-header bttl">
				<h3>Edit Kategori Destinasi Wisata</h3>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
			<form class="form-horizontal edt" action="/reference/category/{{$category->id}}" method="POST" enctype="multipart/form-data">
